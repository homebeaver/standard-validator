 ...
 * @since 1.10.0
 */
public final class VATidMTCheckDigit extends ModulusCheckDigit implements IsoIecConstants {
    ...
    public String calculate(final String code) throws CheckDigitException {
        ...
        return toCheckDigit(cdValue == 0 ? MODULUS_37 : cdValue);
    }
    ...
    public boolean isValid(final String code) {
        ...
        final String check = code.substring(code.length() - getCheckdigitLength());
